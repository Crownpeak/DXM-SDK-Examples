    ...
    <div class="p-3">
        ...
        <ol class="list-unstyled mb-0">
          <!-- cp-scaffold
            ...
            <li v-for="month in months" :key="month"><router-link :to="'/blog/' + month.substr(0,7)">{{ new Date(month).toLocaleString('default', { month: 'long', year: 'numeric' }) }}</router-link></li>
          <!-- /cp-scaffold -->
        </ol>
    </div>
</template>
